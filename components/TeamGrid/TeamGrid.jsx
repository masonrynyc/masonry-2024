		...
		>
			<div className="px-margin">
				<div className="mx-auto max-w-site-max-w">
					<ScrollEntrance className="grid gap-x-gutter gap-y-v-space-sm md:gap-y-4 md:grid-cols-3 lg:grid-cols-12 items-top">
						<div className="col-span-full border-t"/>
						<div className='lg:col-span-5'><h3 className="h5">{title}</h3></div>
